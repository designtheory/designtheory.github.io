...
Well there are various easy methods for a programmer to create an algorithm that can generate random words, but may be 
they dont look natural enough for the eye to look like an article. The Solution was easy, take a article from an book,
